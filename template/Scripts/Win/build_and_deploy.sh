...
"$QT_DIR/$QT_VERSION/$QT_COMPILER_DIR/bin/windeployqt.exe" --release --qmldir "${PROJECT_DIR}/QML_Project/QML" "${DEPLOY_DIR_NAME}/bin/${PROJECT_NAME}.exe"
...
TRANSLATIONS_DIR="${PROJECT_DIR}/QML_Project/Resources/Translations"
